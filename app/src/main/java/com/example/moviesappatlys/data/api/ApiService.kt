...
interface ApiService {
    //Search Movie  https://api.themoviedb.org/3/search/movie?query=deadpool&include_adult=true&language=en-US&page=1&api_key=YOUR_KEY
    //Trending Movies https://api.themoviedb.org/3/trending/movie/day?language=en-US&api_key=YOUR_KEY
